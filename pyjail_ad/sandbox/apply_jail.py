...
DEFAULT_JAIL = """from typing import Tuple
...
def jail(code: str) -> Tuple[bool, str]:
    ...
    - second value is the modified the code, but it must satisfy len(new_code) <= len(code) + 50 or your jail will be ignored
